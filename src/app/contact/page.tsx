            ...
            <main className="bg-[var(--color-charcoal)] min-h-screen">
                ...
                <Section background="charcoal" className="pt-0 pb-24">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 h-full">
                                ...
                                <div className="flex items-start gap-6 group">
                                    ...
                                    <div>
                                        ...
                                        <div className="text-gray-400 space-y-1">
                                            <div className="flex flex-wrap justify-between w-full max-w-xs gap-4">
                                                <span>Lundi &mdash; Vendredi</span>
                                                <span className="text-white font-medium">09:00 &mdash; 18:00</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        {/* Map */}
                        <div className="rounded-[var(--radius-xl)] overflow-hidden border border-white/5 shadow-2xl h-[500px] lg:h-auto relative group">
                            <iframe

                            ...
                            <div className="flex flex-col sm:flex-row items-center sm:items-start text-center sm:text-left gap-5 md:gap-6">
                                ...
                                <div className="flex flex-col items-center sm:items-start">
                                    <h3 className="text-white font-black uppercase tracking-tight text-2xl md:text-4xl mb-3 sm:mb-2 flex flex-wrap justify-center sm:justify-start items-center gap-x-3 gap-y-3">
                                        Offre du <span className="text-[#ff3333] drop-shadow-[0_0_12px_rgba(220,38,38,0.8)]">moment</span>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 relative z-10">
                            ...
                            <div className="flex flex-col h-full bg-black/40 border border-white/5 hover:border-[var(--color-red)]/30 rounded-[1.5rem] p-6 md:p-8 hover:bg-white/[0.02] transition-all duration-300 group hover:shadow-[0_0_30px_rgba(220,38,38,0.1)]">
                                <div className="flex items-start gap-4 mb-6 md:mb-8">
                                    <div className="w-12 h-12 rounded-[1rem] bg-gradient-to-br from-white/10 to-white/5 border border-white/10 flex items-center justify-center text-[#ff3333] drop-shadow-[0_0_10px_rgba(220,38,38,0.8)] group-hover:scale-110 group-hover:bg-[#ff3333]/10 transition-all duration-500">
                                        <Settings className="w-6 h-6" />
                                    </div>
                                    <div>
                                        <h4 className="text-[#ff3333] drop-shadow-[0_0_10px_rgba(220,38,38,0.8)] font-black text-[1.1rem] md:text-xl uppercase tracking-tight mb-1">Kit de distribution</h4>
                            ...
                            {/* Offer 2 */}
                             <div className="flex flex-col h-full bg-black/40 border border-white/5 hover:border-[var(--color-red)]/30 rounded-[1.5rem] p-6 md:p-8 hover:bg-white/[0.02] transition-all duration-300 group hover:shadow-[0_0_30px_rgba(220,38,38,0.1)]">
                                <div className="flex items-start gap-4 mb-6 md:mb-8">
                                    ...
                                    <div>
                                        <h4 className="text-[#ff3333] drop-shadow-[0_0_10px_rgba(220,38,38,0.8)] font-black text-[1.1rem] md:text-xl uppercase tracking-tight mb-1">Disques & Plaquettes</h4>
